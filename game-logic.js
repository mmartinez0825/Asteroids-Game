...
// Add an event listener for the "keydown" event to detect the Enter key press
...
function startGame() {
  // Remove the event listener to prevent starting the game multiple times
  ...
  startButton.addEventListener("click", function () {
    ...
    if (backgroundMusic.paused || backgroundMusic.ended) {
      // If paused or ended, play the music
      backgroundMusic.play();
      startButton.textContent = "Pause Music"; // Change button text
    } else {
